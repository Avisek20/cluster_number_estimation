...
if __name__ == '__main__' :
    ...
    for SET_INDEX in list_indices:
        ...
        for dir_num in range(30) :
            ...
            fw.close()
            if SET_INDEX == 22 : # Slope and sillhouette
                ...
                fw2.close()
            if SET_INDEX == 9 : # Gap-Stat and Mohajer Gap-Stat
            ...
            for a_dataset in range(25) :
                ...
                if SET_INDEX not in [9, 22] :
                    ...
                    fw.write(str(end)+'\n')
                    fw.close()
                elif SET_INDEX == 9 : # Gapstat and Mohajer gap
                    fw = open(results_today+'/'+results_directory[SET_INDEX]+\
                    '/result'+str(dir_num)+'.txt', 'a')
                    ...
                    fw2.write(str(end)+'\n')
                    fw2.close()
                elif SET_INDEX == 22 : # Slope and sillhouette
                    fw = open(results_today+'/'+results_directory[SET_INDEX]+\
                    '/result'+str(dir_num)+'.txt', 'a')
                    fw.write(str(est_k[0])+'\n')
                    fw.close()
